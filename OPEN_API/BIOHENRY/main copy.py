...
while dd < 21:
    ...
    input_file_path = './OPEN_API/BIOHENRY/data/one-minute-data_Nigeria-SO-Ogoja-Office_8-16_8-22-2023.csv'
    galooli_file_path = './OPEN_API/BIOHENRY/data/liters_2023-08-%s.csv' % ('0%s' % dd)[-2:]
    output_file_path = './OPEN_API/BIOHENRY/data/output3.csv'

    #True for write, False for append
    header = False
    # last of previous  month epoch
    epStart = 1690844400  + (86400 * (dd-1))
    epEnd = epStart + 86340
