...
while dd < 9:
    ...
    input_file_path = 'E:/OneDrive - UNHCR/GEEPP/RETSCREEN/raw-data/Ogoja-office/Eyedro_Nigeria-SO-Ogoja-office_8-3_8-9-2023.csv'
    galooli_file_path = './liters_2023-08-%s.csv' % ('0%s' % dd)[-2:]
